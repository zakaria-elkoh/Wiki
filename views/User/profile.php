                ...
                <?php foreach($wikis as $wiki) : ?>
                  <div class="relative">
                      <a href="show-wiki?wiki_id=<?= $wiki['id']; ?>" class="w-full p-5 bg-['#555'] hover:bg-[#2a2a2a] flex items-center border border-gray-700 rounded-lg shadow">
                        ...
                        <a href="delete?id=<?= base64_encode($wiki['id']); ?>"  class="text-red-700 cursor-pointer absolute right-20 top-2 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:red:bg-blue-500 dark:focus:ring-red-800">delete</a>
                  </div>
                <?php endforeach; ?>
            </div>
