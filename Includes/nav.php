    ...
    <nav class="bg-[#222] border-b border-gray-600 fixed top-0 left-0 w-full">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-6">
            ...
            <div class="search-wrapper grow max-w-md">
            ...
            <div class="hidden grow w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col justify-end p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                    <li>
                    ...
                    <li>
                        <a href="create" class="<?= ($_SERVER['REQUEST_URI'] === '/wiki/create') ? 'text-blue-500' : 'text-white' ; ?> block py-2 px-3 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0">Write</a>
                    </li>
