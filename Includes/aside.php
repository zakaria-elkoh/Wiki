    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-[#111]">
            <ul class="space-y-2 font-medium">
                <li class="rounded-lg <?= ($_SERVER['REQUEST_URI'] == '/wiki/admin/dashboard') ? 'bg-gray-700' : '' ; ?>">
                ...
                <li class="rounded-lg <?= ($_SERVER['REQUEST_URI'] == '/wiki/admin/users') ? 'bg-gray-700' : '' ; ?>">
                ...
                <li class="rounded-lg <?= ($_SERVER['REQUEST_URI'] == '/wiki/admin/wikis') ? 'bg-gray-700' : '' ; ?>">
                ...
                <li class="rounded-lg <?= ($_SERVER['REQUEST_URI'] == '/wiki/admin/categories') ? 'bg-gray-700' : '' ; ?>">
                ...
                <li class="rounded-lg <?= ($_SERVER['REQUEST_URI'] == '/wiki/admin/tags') ? 'bg-gray-700' : '' ; ?>">
